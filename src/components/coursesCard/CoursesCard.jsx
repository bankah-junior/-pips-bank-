  ...
  return (
    <div>
        <div className="w-full flex flex-col md:flex-row md:items-center my-4 card">
            <div className="w-full p-2 flex items-center rounded-lg md:justify-start justify-center relative overflow-hidden cursor-pointer">
            ...
            <div className="p-2 md:p-0 relative ml-4">
                <span className="px-2 py-1 text-white rounded" style={{ backgroundColor: "#3F3D56" }}>{courseLevel}</span>
