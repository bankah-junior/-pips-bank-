  ...
  return (
    ...
    <div className="cover">
      <div className="front">
        ...
        <div className="text">
          <span className="text-1">Discover | Learn | Invest | Trade <br /> Pips Bank</span>
        ...
        <div className="form-content">
          ...
          <form action="#">
            <div className="input-boxes">
              ...
              <div className="text"><a href="#fp">Forgot password?</a></div>
              <div className="button input-box">
                {/* <input type="submit" value="Sumbit" /> */}
              </div>
              <Link to='/home' className='p-2 rounded' style={{backgroundColor: "#7d2ae8", color: "white"}}>
                <button className=' demo-btn w-full font-semibold'>Submit</button>
              </Link>
